...
class Slider extends Model implements \OwenIt\Auditing\Contracts\Auditable
{
    ...
    public const HOMEPAGE_CLIENTS_SLIDER = "Homepage Clients Slider";
    public const ABOUT_US_CLIENTS_SLIDER = "About Us Clients Slider";
    ...
    public static function getCategories(){
        return [
            ...
            self::HOMEPAGE_CLIENTS_SLIDER => __(self::HOMEPAGE_CLIENTS_SLIDER),
            self::ABOUT_US_CLIENTS_SLIDER => __(self::ABOUT_US_CLIENTS_SLIDER),
        ];
    }
