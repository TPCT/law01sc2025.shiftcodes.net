                        ...
                        ->schema([
                            ...
                            Forms\Components\Repeater::make('slides')
                                ...
                                ->schema([
                                    ...
                                    ])->visible(fn (Forms\Get $get) => in_array($get('data.category', true), [Slider::HOMEPAGE_HERO_SLIDER])),
                                    Forms\Components\Grid::make(2)->schema([
                                        FileUpload::make('image_id')
                                            ->label(__("Image")),
                                        FileUpload::make('hover_image_id')
                                            ->label(__("Hover Image")),
                                    ])->visible(fn (Forms\Get $get) => in_array($get('data.category', true), [Slider::HOMEPAGE_CLIENTS_SLIDER, Slider::ABOUT_US_CLIENTS_SLIDER])),
                            ])
                            ->collapsible()
                            ->minItems(0)
                            ->defaultItems(0),
