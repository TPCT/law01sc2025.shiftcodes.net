                        ...
                        Forms\Components\Section::make()->schema(
                            array_merge(
                                ...
                                Select::make('dropdown_id')
                                    ...
                                    ->relationship('category', 'dropdowns_lang.title', modifyQueryUsing: function (\Illuminate\Database\Eloquent\Builder $query){
                                        $query->join('dropdowns_lang', 'dropdowns.id', '=', 'dropdowns_lang.parent_id')
                                            ->where('category', Dropdown::BLOG_CATEGORY)
